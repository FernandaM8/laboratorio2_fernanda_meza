...
function onSubmitProduct(event) {
    ...
    const productCard = document.getElementById('app-product');
    const htmlContent = buildProductCard(product, 0);
  ...
  function onSubmitClient(event) {
    ...
    const clientCard = document.getElementById('app-client');
    const htmlContent = buildClientCard(client, 0);
    clientCard.innerHTML = htmlContent;
    // logica para la recuparacion de datos
